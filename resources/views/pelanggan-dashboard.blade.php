    ...
    <div class="relative min-h-screen bg-gray-50/50 pb-12">
        ...
        <div class="relative z-10">
                ...
                <div class="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-black mt-0.5 font-light">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-10">
                ...
                <div class="mb-10">
                    <h4 class="text-[10px] font-bold text-black uppercase tracking-[0.2em] mb-4 ml-1">Status Pengaduan Aktif</h4>
                    ...
                    <div class="group relative bg-white/80 backdrop-blur-xl rounded-[2rem] sm:rounded-[2.5rem] border border-white shadow-2xl shadow-gray-200/50 overflow-hidden transition-all duration-500">
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-3">
                                        ...
                                        <span class="text-xs text-black font-medium font-mono">#{{ $tiketAktif->nomor_tiket ?? $tiketAktif->id }}</span>
                                    </div>
                                    ...
                                    <div class="mt-4 sm:mt-6 flex items-center gap-6 text-[11px] text-black font-light">
                                        <div class="flex items-center gap-1.5">
                                            <svg class="w-3.5 h-3.5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                        ...
                        <div class="bg-gray-50/50 px-6 sm:px-8 py-3.5 border-t border-gray-100/50">
                            <p class="text-[10px] text-black italic font-medium">
                    ...
                    <div class="bg-white/40 backdrop-blur-sm border-2 border-dashed border-gray-200 rounded-[2rem] p-8 sm:p-12 text-center group hover:border-red-200 transition-all duration-500">
                        ...
                        <p class="text-xs text-black font-light mt-0.5 mb-5">Anda tidak memiliki tiket gangguan berjalan. Klik tombol di bawah jika butuh bantuan teknis.</p>
                        <a href="{{ route('pengaduan.create') }}" class="inline-flex items-center px-6 py-2.5 bg-white border border-gray-200 rounded-full text-[10px] font-bold tracking-widest text-black hover:border-red-600 hover:text-red-600 transition-all shadow-sm">
                ...
                <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/40 border border-gray-100 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-50 flex items-center justify-between bg-gray-50/30">
                        ...
                        <span class="text-[9px] font-bold text-black bg-white px-2.5 py-0.5 rounded-full border border-gray-100 font-mono">{{ count($riwayatTiket) }} ITEMS</span>
                    </div>
                    
                    <div class="hidden md:block overflow-x-auto">
                        <table class="w-full text-left">
                            <thead>
                                <tr class="text-[10px] text-black uppercase tracking-[0.15em]">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr class="hover:bg-gray-50/50 transition-all duration-200">
                                    <td class="px-8 py-5"><span class="text-xs font-bold text-black font-mono">#{{ $riwayat->nomor_tiket }}</span></td>
                                    <td class="px-8 py-5"><span class="text-xs text-black font-light">{{ $riwayat->created_at->format('d/m/Y') }}</span></td>
                                    <td class="px-8 py-5"><p class="text-xs text-black max-w-xs truncate">{{ $riwayat->deskripsi_keluhan ?? $riwayat->judul }}</p></td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="px-8 py-16 text-center text-xs font-light text-black">Belum ada riwayat berkas penanganan selesai.</td>
                                </tr>
                                @endforelse
                    ...
                    <div class="block md:hidden divide-y divide-gray-100">
                        ...
                        @empty
                        <div class="p-8 text-center text-xs font-light text-black">Belum ada riwayat berkas penanganan selesai.</div>
                        @endforelse
                    </div>
